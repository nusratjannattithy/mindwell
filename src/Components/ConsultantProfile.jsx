...
const ConsultantProfile = () => {
  ...
  const handleBookNowClick = () => {
    ...
    try {
      // Always navigate to login page first with showAppointmentForm flag
      navigate('/login', { state: { from: `/consultant/${id}`, consultantId: id, consultantName: consultant?.fullName || '', showAppointmentForm: true } });
    } catch (error) {
